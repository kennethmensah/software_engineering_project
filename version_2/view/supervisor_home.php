                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="user-header bg-light-blue">
                            ...
                            <p>
                                ...
                                <small> <?php echo "Time is " . date("h:i:sa")?></small>
                            </p>
                        </li>
                        <!-- Menu Body -->
                        <li class="user-body">
...
<div class="wrapper row-offcanvas row-offcanvas-left">
    ...
    <aside class="left-side sidebar-offcanvas">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
                <li class="active">
                    <a href="javascript: load_dashboard()">
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="javascript:void(0)"><i class="fa fa-angle-double-right"></i> District</a></li>
                        <li><a href="javascript: loadClinicTasks()"><i class="fa fa-angle-double-right"></i> Clinic</a></li>
                    </ul>
                </li>
                <li class="treeview">
                    <a href="#">
    ...
    <aside class="right-side">
        ...
        <section class="content" id="sub_content">
